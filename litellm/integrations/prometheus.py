...
class PrometheusLogger(CustomLogger):
    ...
    def _get_guardrail_overhead_seconds(
        ...
        return sum(
            (
                ...
                if PrometheusLogger._guardrail_is_additive(info)
            ),
            0.0,
        )
    ...
    def _set_total_overhead_metric(
        ...
        """Record litellm_total_overhead_latency_metric (seconds): SDK overhead +
        ...
        total_overhead_labels = prometheus_label_factory(
            supported_enum_labels=self.get_labels_for_metric(metric_name="litellm_total_overhead_latency_metric"),
